      ...
      <div class="w-full max-w-3xl">
        ...
        <div class="bg-white rounded-3xl shadow-2xl p-8 animate-scale-in">
          ...
          <div class="text-center mb-8">
            <h1 class="text-4xl font-bold text-gray-800 mb-3">Add New Contract</h1>
            <p class="text-gray-500">Create a new sponsorship agreement and partnership contract.</p>
          </div>
          ...
          <div class="space-y-5">
            ...
            <div class="pt-4 flex gap-4 items-center">
              <button (click)="addContract()"
                ...
                <span class="relative z-10">{{ isLoading ? 'Saving...' : 'Save Contract' }}</span>
              </button>
