...
Write-Host "1️⃣  CHECKING DOCKER SERVICES" -ForegroundColor Cyan
...
Write-Host "2️⃣  CHECKING KUBERNETES" -ForegroundColor Cyan
Write-Host "=========================================" -ForegroundColor Gray
...
Write-Host "3️⃣  TESTING APPLICATION ENDPOINTS" -ForegroundColor Cyan
Write-Host "=========================================" -ForegroundColor Gray
$endpoints = @(
...
Write-Host "4️⃣  CHECKING DOCKER IMAGES" -ForegroundColor Cyan
Write-Host "=========================================" -ForegroundColor Gray
...
try {
    ...
    Write-Host "   ❌ Cannot access registry" -ForegroundColor Red
}
Write-Host ""

Write-Host "5️⃣  RUNNING UNIT TESTS" -ForegroundColor Cyan
Write-Host "=========================================" -ForegroundColor Gray
...
Write-Host "6️⃣  JENKINS PIPELINE STATUS" -ForegroundColor Cyan
Write-Host "=========================================" -ForegroundColor Gray
...
Write-Host "7️⃣  CREDENTIALS CONFIGURATION" -ForegroundColor Cyan
Write-Host "=========================================" -ForegroundColor Gray
Write-Host "⚠️  Make sure you configured Jenkins credentials:" -ForegroundColor Yellow
