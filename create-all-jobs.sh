...
CRUMB_JSON=$(curl -s -c /tmp/jenkins-cookie.txt -u "$USER:$PASSWORD" "$JENKINS_URL/crumbIssuer/api/json")
...
create_job "learning-service"           "Backend/learning/Jenkinsfile"                   "Pipeline for Learning Service"
create_job "skill-evidence-service"     "Backend/skiil-evidence-service/Jenkinsfile"     "Pipeline for Skill Evidence Service"
